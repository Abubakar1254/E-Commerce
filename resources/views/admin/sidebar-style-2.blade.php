							...
							<div class="card card-primary bg-primary-gradient">
								<div class="card-body">
									...
									<ul class="list-unstyled">
										<li class="d-flex justify-content-between pb-1 pt-1"><small>/product/readypro/index </small> <span>7</span></li>
										<li class="d-flex justify-content-between pb-1 pt-1"><small>/product/kaiadmin/demo </small> <span>10</span></li>
									</ul>
								</div>
							</div>
						</div>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">/kaiadmin/index </th>
                            <td>3,985</td>
                            <td>319</td>
                            <td>
                              <i
                          ...
                          <tr>
                            <th scope="row">/kaiadmin/charts </th>
                            <td>3,513</td>
                            <td>294</td>
                            <td>
                              <i
                          ...
                          <tr>
                            <th scope="row">/kaiadmin/tables </th>
                            <td>2,050</td>
                            <td>147</td>
                            <td>
                              <i class="fas fa-arrow-up text-success me-3"></i>
                          ...
                          <tr>
                            <th scope="row">/kaiadmin/profile </th>
                            <td>1,795</td>
                            <td>190</td>
                            <td>

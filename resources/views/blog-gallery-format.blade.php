...
@include('components.second-nav' ,['link' => '/' , 'first' => 'Home' , 'second' => 'Blog Gallery Format'])
                                ...
                                <div class="li-blog-gallery-slider slick-dot-style">
                                    <div class="li-blog-banner">
                                        <a href="blog-details.html"><img class="img-full"
                                                src="images/blog-banner/large-size/1.jpg" alt="Product Image"></a>
                                    </div>
                                    <div class="li-blog-banner">
                                        <a href="blog-details.html"><img class="img-full"
                                                src="images/blog-banner/large-size/2.jpg" alt="Product Image"></a>
                                    </div>
                                    <div class="li-blog-banner">
                                        <a href="blog-details.html"><img class="img-full"
                                                src="images/blog-banner/large-size/3.jpg" alt="Product Image"></a>
                                    </div>
                                </div>
                                <div class="li-blog-content">
                                    <div class="li-blog-details">
                                        <h3 class="li-blog-heading pt-35"><a href="blog-details.html">The Biggest Collection
                                                For Digital Product</a></h3>
